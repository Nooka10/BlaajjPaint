...
public class RightMenuController {
	 ...
	 */
	private class NewLayerSave implements ICmd {
	 ...
	 */
	private class DeleteLayerSave implements ICmd {
		private Layer oldCurrentLayer;
		private Layer newLayer;
		private int index;
	 ...
	 */
	private class LayerPosSave implements ICmd {
		private int index;
	 ...
	 */
	private class MergeSave implements ICmd {
