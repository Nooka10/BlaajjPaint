...
/**
 * Contrôleur associé au fichier FXML ParamShapeController.fxml et gérant l'ensemble des actions associées à la barre de menus des formes qui apparaît dans la GUI
 * en dessous de la barre de menus, lorsqu'on sélectionne l'outil <b>Formes</b>.
 */
public class ParamShapeController {
	...
	/**
	 * Méthode appelée par le slider de la barre de menu des formes lorsque l'utilisateur clique avec la souris sur le slider d'opacité du calque, lorsqu'il reste
	 * appuyé et glisse ou encore lorsqu'il relâche le clic.
	 * Modifie l'épaisseur des contours des formes vides. Ne fait rien pour les formes pleines.
	 */
	...
	/**
	 * Méthode appelée lorsque l'utilisateur clique sur le bouton <b>Rectangle vide</b> de la barre de menus des formes située en dessous de la barre de menus dans
	 * la GUI.
	 * Sélectionne l'outil <b>Rectangle vide</b> permettant à l'utilisateur de dessiner un rectangle vide avec des bordures de l'épaisseur définie par le slider et
	...
	/**
	 * Méthode appelée lorsque l'utilisateur clique sur le bouton <b>Rectangle plein</b> de la barre de menus des formes située en dessous de la barre de menus dans
	 * la GUI.
	 * Sélectionne l'outil <b>Rectangle plein</b> permettant à l'utilisateur de dessiner un rectangle plein de la couleur actuellement sélectionnée dans le sélecteur
	 * de couleurs.
	 */
    @FXML
	...
	/**
	 * Méthode appelée lorsque l'utilisateur clique sur le bouton <b>Ellipse vide</b> de la barre de menus des formes située en dessous de la barre de menus dans
	 * la GUI.
	 * Sélectionne l'outil <b>Ellipse vide</b> permettant à l'utilisateur de dessiner une ellipse vide avec des bordures de l'épaisseur définie par le slider et
	 * le textField, et de la couleur actuellement sélectionnée dans le sélecteur de couleurs.
	 */
    @FXML
	...
	/**
	 * Méthode appelée lorsque l'utilisateur clique sur le bouton <b>Ellipse pleine</b> de la barre de menus des formes située en dessous de la barre de menus dans
	 * la GUI.
	 * Sélectionne l'outil <b>Ellipse pleine</b> permettant à l'utilisateur de dessiner une ellipse pleine de la couleur actuellement sélectionnée dans le sélecteur
	 * de couleurs.
	 */
    @FXML
